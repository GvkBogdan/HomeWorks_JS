...
/*document.write(`<div class="simpsons1">`);
for (let i = 0; i < simpsons.length; i++) {
	document.write(`${simpsons[i].name}-${simpsons[i].surname}-${simpsons[i].age}-${simpsons[i].info}-<img src="${simpsons[i].photo}" alt=""> <br>`);
}
document.write(`</div>`);*/
...
//         <img src="PHOTO" alt="">
//     </div>
//-----------------------------------template 2.3---THE SOLUTION OF HOMEWORK-------------------------------------------

/*document.write(`<div class="simpsons3">`)
for (let i = 0; i < simpsons.length; i++) {
    document.write(`<div>`);
	document.write(`<h2>${simpsons[i].name}-${simpsons[i].surname}-age is ${simpsons[i].age}</h2>
<p>${simpsons[i].info}</p>
...
/*
            ...
            <div class="product-card">
                ...
                */
//-----------------------------------template 3.1---THE SOLUTION OF HOMEWORK-------------------------------------------
...
for (let i = 0; i < arrUsers.length; i++) {
	...
	document.write(`<h3>${arrUsers[i].id} - ${arrUsers[i].title}</h3>
<p>${arrUsers[i].body}</p> <br>`);
    document.write(`</div>`);
}
document.write(`</div>`);
...
for (const users of usersLists) {
    document.write(`<div class="user-block">`);
    document.write(`<h2>${users.id} - ${users.name} - ${users.username}</h2>`);
    document.write(`<h3>EMAIL - ${users.email} _ PHONE - ${users.phone}</h3>`);
    document.write(`<div class="address-block">`);
    document.write(`<p> City -${users.address.city} </p>`);
    document.write(`<p> Srteer -${users.address.street} </p>`);
    document.write(`<p> Suite -${users.address.suite} </p>`);
    document.write(`<p> Zipcode -${users.address.zipcode} </p>`);
    document.write(`</div>`);
    document.write(`</div>`);
