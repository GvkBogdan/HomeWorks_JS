...
userBox.innerText = 'Box-Total';
document.body.appendChild(userBox);
for (const user of users) {
    let div = document.createElement('div')
    console.log(user);
    div.innerText = 'user' + user;
...
for (const user of users) {
    ...
    for (const Element in user) {
        ...
        if (Element === 'address'){
            ...
            divadress.innerText =  'adress';
            div.appendChild(divadress)
        for (const ElementKey in user.address) {
            let divElement = document.createElement('div')
            divElement.innerText =  ElementKey;
            divadress.appendChild(divElement)
...
let idcontrnt = document.getElementById('content')
idcontrnt.appendChild(ul)
for (let i = 0; i < h2title.length; i++) {
    console.log(h2title[i].innerText);
    let li = document.createElement('li');
    li.innerText = h2title[i].innerText;
    ul.appendChild(li);
}
*/
//----------------------------------------------------------------------------------------------------------------
...
//     for (const eleKey in ele.address) {
//         console.log(eleKey);
//     }
//
// }
